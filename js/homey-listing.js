jQuery(document).ready( function($) {
    ...
    if ( typeof Homey_Listing !== "undefined" ) {
        ...
        var uploaded_of_text = Homey_Listing.uploaded_of_text;
        var process_completed_text = Homey_Listing.process_completed_text;
        ...
        $('ul#form_tabs li, .btn-save-listing').on('click', function() {
            ...
            if (form.valid()) {
                ...
                if($(document).find("select[name='checkin_after']").hasClass("error")){
                    var errorListingTypeBtn = $(document).find("button[data-id='checkin_after']");
                    $(errorListingTypeBtn).css("border-color", "#c31b1b");
                    $(errorListingTypeBtn).css("background-color", "#F6C8C8");
                }

                if($(document).find("select[name='checkout_before']").hasClass("error")){
                    var errorListingTypeBtn = $(document).find("button[data-id='checkout_before']");
                    $(errorListingTypeBtn).css("border-color", "#c31b1b");
                    $(errorListingTypeBtn).css("background-color", "#F6C8C8");
                }
        ...
        btnnext.on('click', function(e) {
            if(edit_tab != 'media'){
                $(".form-step-gal1").removeClass('active');
            }
...
function validateImageLength() {
    var images = jQuery("#homey_gallery_container .listing-thumb").length;
    if(images >= 5) {
        return true;
    }else {
        return false;
