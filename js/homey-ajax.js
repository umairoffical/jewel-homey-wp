            ...
            $.ajax({
                ...
                success: function(data) {
                    if( data.success ) {
                        ...
                        $('.single-total-hours').show();
                        $('.total-hours-value').text(data.total_hours);
                    } else {
                        if(notify.find('.notify').length > 1) {
                            notify.find('.notify').first().remove();
                        }
        ...
        if(homey_booking_type != 'per_hour') {
            ...
            * */
            ...
            var homey_calculate_price_checkin = function() {
                ...
                homey_calculate_booking_cost(check_in_date, check_out_date, start_hour, end_hour, guests, listing_id, security);
            }
