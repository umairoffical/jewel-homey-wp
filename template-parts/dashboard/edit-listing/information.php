...
$lisitng_id = $listing_data->ID;
$timeperiod_availability = get_post_meta($lisitng_id,'homey_timeperiod_availbility', true);
?>
        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="number" name="beds" id="beds" <?php homey_required('beds'); ?> value="<?php homey_field_meta('beds'); ?>" class="form-control" placeholder="<?php echo esc_attr(homey_option('ad_no_of_beds_plac')); ?>">
                </div>
            </div>
            <?php } ?>
            ...
            <div class="col-sm-6 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="number" name="baths" id="baths" <?php homey_required('baths'); ?> value="<?php homey_field_meta('baths'); ?>" class="form-control" placeholder="<?php echo esc_attr(homey_option('ad_no_of_bathrooms_plac')); ?>">
                </div>
            </div>
            <?php } ?>
            ...
            <div class="col-sm-6 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" value="<?php homey_field_meta('listing_rooms'); ?>" name="listing_rooms" id="listing_rooms" <?php homey_required('listing_rooms'); ?> placeholder="<?php echo esc_attr(homey_option('ad_listing_rooms_plac'));?>">
                </div>
            </div>
            <?php } ?>
            ...
            <div class="col-sm-6 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="listing_size" value="<?php homey_field_meta('listing_size'); ?>" id="listing_size" <?php homey_required('listing_size'); ?> placeholder="<?php echo esc_attr(homey_option('ad_size_placeholder'));?>">
                </div>
            </div>
            <?php } ?>
            ...
            <!-- <div class="col-sm-6 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="hidden" class="form-control" name="listing_size_unit" value="Sqft" <?php homey_required('listing_size_unit'); ?> id="listing_size_unit" placeholder="<?php echo esc_attr(homey_option('ad_listing_size_unit_plac'));?>">
                <!-- </div>
            </div> -->
            <?php } ?>
                    ...
                    <div class="opening-hours-container">
                        <div class="opening-hours-row">
                            <div class="row timeperiod-single-day">
                                ...
                                <div class="col-sm-3 col-xs-6 check_is_available">
                            ...
                            <?php
                            $days = [
                                'mon' => esc_html__('Monday', 'homey-child'),
                                'tue' => esc_html__('Tuesday', 'homey-child'),
                                'wed' => esc_html__('Wednesday', 'homey-child'),
                                'thu' => esc_html__('Thursday', 'homey-child'),
                                'fri' => esc_html__('Friday', 'homey-child'),
                                'sat' => esc_html__('Saturday', 'homey-child'),
                                'sun' => esc_html__('Sunday', 'homey-child'),
                            ];

                            foreach ($days as $key => $day) {
                                $available = isset($timeperiod_availability[$key . '_available']) ? $timeperiod_availability[$key . '_available'] : 'no';
                                $open_time = isset($timeperiod_availability[$key . '_open_time']) ? $timeperiod_availability[$key . '_open_time'] : '';
                                $close_time = isset($timeperiod_availability[$key . '_close_time']) ? $timeperiod_availability[$key . '_close_time'] : '';
                                ?>
                                <div class="row timeperiod-single-day">
                                    <div class="col-sm-2 col-xs-6">
                                        <h5 class="mt-10"><?php echo $day; ?></h5>
                                    </div>
                                    <div class="col-sm-3 col-xs-6">
                                        <div class="check-day-availability">
                                            <div class="form-group mb-0">
                                                <label class="control control--radio radio-tab">
                                                    <input type="radio" class="radio_check_avaialable" name="timeperiod[<?php echo $key; ?>_available]" value="yes" <?php checked($available, 'yes'); ?>>
                                            ...
                                            <div class="form-group mb-0">
                                                <label class="control control--radio radio-tab">
                                                    <input type="radio" class="radio_check_avaialable" name="timeperiod[<?php echo $key; ?>_available]" value="no" <?php checked($available, 'no'); ?>>
                                    ...
                                    <div class="col-sm-3 col-xs-6 check_is_available" style="display: <?php echo $available === 'yes' ? 'block' : 'none'; ?>;">
                                        <select class="form-control" name="timeperiod[<?php echo $key; ?>_open_time]">
                                            <?php
                                            $times = homey_get_times_options();
                                            foreach ($times as $time_key => $time) {
                                                echo '<option value="' . $time_key . '" ' . selected($open_time, $time_key, false) . '>' . $time . '</option>';
                                            }
                                            ?>
                                        </select>
                                    </div>
                                    <div class="col-sm-3 col-xs-6 check_is_available" style="display: <?php echo $available === 'yes' ? 'block' : 'none'; ?>;">
                                        <select class="form-control" name="timeperiod[<?php echo $key; ?>_close_time]">
                                            <?php
                                            foreach ($times as $time_key => $time) {
                                                echo '<option value="' . $time_key . '" ' . selected($close_time, $time_key, false) . '>' . $time . '</option>';
                                            }
                                            ?>
                                        </select>
                                    </div>
