        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="locatioon-welcome-meesage mb-10">
                    ...
                    <textarea name="host_welcome_message" id="host_welcome_message" class="form-control" placeholder="<?php esc_html_e('Enter Host Welcome Message','homey-child'); ?>"><?php echo $welcome_message; ?></textarea>
                </div>
