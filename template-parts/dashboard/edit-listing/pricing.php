...
$guest_prices = get_post_meta($listing_data->ID, 'homey_guest_price', true);
?>
...
<div id="pricing-tab" class="tab-pane fade <?php echo esc_attr($class);?>">
    ...
    <div class="block-body">
        ...
        <div class="row">
            ...
            <?php 
            $guest_prices = get_post_meta($listing_data->ID, 'homey_guest_price', true);
            $guest_prices = maybe_unserialize($guest_prices);

            $guest_ranges = [
                '1_to_5' => esc_html__('1 - 5 Guests', 'homey-child'),
                '6_to_13' => esc_html__('6 - 13 Guests', 'homey-child'),
            ...
            <div class="col-lg-12 col-xs-12 customize-guest-prices">
                ...
                <div class="guest-price-availablity">
                    <?php foreach ($guest_ranges as $key => $label) : ?>
                        <div>
                            <input type="checkbox" id="<?php echo $key; ?>_guest" 
                                   name="guest_price[<?php echo $key; ?>][available]" 
                                   value="yes" 
                                   <?php echo (isset($guest_prices[$key]['available']) && $guest_prices[$key]['available'] === 'yes') ? 'checked' : ''; ?> />
                            <label for="<?php echo $key; ?>_guest"><?php esc_html_e('Is Available?', 'homey-child'); ?></label>
                        </div>
                    <?php endforeach; ?>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-2 col-xs-6">
                <div class="form-group">
                    <label class="control control--radio radio-tab">
                        <input type="radio" <?php checked( $city_fee_type, 'per_guest' ); ?> name="city_fee_type" value="per_guest">
            ...
            <div class="col-sm-3 col-xs-6">
                <div class="form-group">
                    <label class="control control--radio radio-tab">
                        <input type="radio" <?php checked( $city_fee_type, 'daily_per_guest' ); ?> name="city_fee_type" value="daily_per_guest">
