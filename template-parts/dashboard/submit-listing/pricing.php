    ...
    <div class="block">
        ...
        <div class="block-body">
            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-xs-12 customize-guest-prices">
                    <div class="guest-quantities">
                        <span><?php esc_html_e('1 - 5 Guests','homey-child');?></span>
                        <span><?php esc_html_e('6 - 13 Guests','homey-child');?></span>
                    ...
                    <div class="guest-price-availablity">
                        <div>
                            <input type="checkbox" id="1_to_5_guest" name="guest_price[1_to_5][available]" value="yes" />
                            <label for="1_to_5_guest"><?php esc_html_e('Is Available?','homey-child');?></label>
                        </div>
                        <div>
                            <input type="checkbox" id="6_to_13_guest" name="guest_price[6_to_13][available]" value="yes" />
                            <label for="6_to_13_guest"><?php esc_html_e('Is Available?','homey-child');?></label>
                        </div>
                        <div>
                            <input type="checkbox" id="14_to_25_guest" name="guest_price[14_to_25][available]" value="yes" />
                            <label for="14_to_25_guest"><?php esc_html_e('Is Available?','homey-child');?></label>
                        </div>
                        <div>
                            <input type="checkbox" id="26_to_35_guest" name="guest_price[26_to_35][available]" value="yes" />
                            <label for="26_to_35_guest"><?php esc_html_e('Is Available?','homey-child');?></label>
                        </div>
                        <div>
                            <input type="checkbox" id="36_to_50_guest" name="guest_price[36_to_50][available]" value="yes" />
